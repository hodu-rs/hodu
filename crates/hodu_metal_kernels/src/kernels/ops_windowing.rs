...
///
/// # Arguments
/// * `kernel` - Reduce window kernel (reduce_window_max::F32, reduce_window_min::F32,
...
///     4,          // output_shape
/// ];
/// call_ops_reduce_window(&device, &command_buffer, &kernels, reduce_window_max::F32,
...
pub fn call_ops_reduce_window(
    ...
    let pipeline = kernels.load_pipeline(device, Source::Windowing, kernel.0)?;
