...
fn test_reduce_sum_f32() {
    ...
    let result: Vec<f32> = run_reduce(&input, &shape, &reduce_dims, false, reduce_sum::F32);
...
fn test_reduce_max_f32() {
    ...
    let result: Vec<f32> = run_reduce(&input, &shape, &reduce_dims, false, reduce_max::F32);
...
fn test_reduce_min_f32() {
    ...
    let result: Vec<f32> = run_reduce(&input, &shape, &reduce_dims, false, reduce_min::F32);
...
fn test_reduce_mean_f32() {
    ...
    let result: Vec<f32> = run_reduce(&input, &shape, &reduce_dims, false, reduce_mean::F32);
...
fn test_reduce_argmax_f32() {
    ...
    let result: Vec<i32> = run_reduce_output(&input, &shape, &reduce_dims, false, reduce_argmax::F32);
...
fn test_reduce_argmin_f32() {
    ...
    let result: Vec<i32> = run_reduce_output(&input, &shape, &reduce_dims, false, reduce_argmin::F32);
...
fn test_reduce_sum_f32_keep_dim() {
    ...
    let result: Vec<f32> = run_reduce(&input, &shape, &reduce_dims, true, reduce_sum::F32);
