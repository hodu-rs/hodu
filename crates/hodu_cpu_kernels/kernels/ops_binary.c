        ...
        if (lhs_cont && rhs_cont) {                                                                \
            ...
            if (num_threads > 1) {                                                                 \
                ...
                for (size_t t = 0; t < num_threads; t++) {                                         \
                    ...
                    thread_create(&threads[t], binary_##OP_NAME##_##TYPE_SUFFIX##_worker,          \
                                  &args[t]);                                                       \
                }                                                                                  \
                                                                                                   \
                for (size_t t = 0; t < num_threads; t++) {                                         \
...
#endif
IMPL_BINARY_OP(f32_t, f32, rem, fmodf(x, y))
...
#endif
IMPL_BINARY_OP(f64_t, f64, rem, fmod(x, y))
...
IMPL_BINARY_OP(uint8_t, bool, rem, x && !y)
...
IMPL_BINARY_OP_CONVERT(f8e4m3_t, f8e4m3, rem, fmodf(x, y), f8e4m3_to_float, float_to_f8e4m3)
...
IMPL_BINARY_OP_CONVERT(f8e5m2_t, f8e5m2, rem, fmodf(x, y), f8e5m2_to_float, float_to_f8e5m2)
...
IMPL_BINARY_OP_CONVERT(bf16_t, bf16, rem, fmodf(x, y), bf16_to_float, float_to_bf16)
...
IMPL_BINARY_OP_CONVERT(f16_t, f16, rem, fmodf(x, y), f16_to_float, float_to_f16)
...
IMPL_BINARY_OP(u8_t, u8, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(u16_t, u16, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(u32_t, u32, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(u64_t, u64, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(i8_t, i8, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(i16_t, i16, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(i32_t, i32, rem, (y != 0) ? (x % y) : 0)
...
IMPL_BINARY_OP(i64_t, i64, rem, (y != 0) ? (x % y) : 0)
