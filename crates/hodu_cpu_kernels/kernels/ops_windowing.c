...
REDUCE_WINDOW_OP(f8e4m3_t, f8e4m3_t, max_f8e4m3, F8E4M3_NEG_INF, acc = MAX(acc, val))
REDUCE_WINDOW_OP(f8e5m2_t, f8e5m2_t, max_f8e5m2, F8E5M2_NEG_INF, acc = MAX(acc, val))
REDUCE_WINDOW_OP(bf16_t, bf16_t, max_bf16, BF16_NEG_INF, acc = MAX(acc, val))
REDUCE_WINDOW_OP(f16_t, f16_t, max_f16, F16_NEG_INF, acc = MAX(acc, val))
...
REDUCE_WINDOW_OP(f8e4m3_t, f8e4m3_t, min_f8e4m3, F8E4M3_POS_INF, acc = MIN(acc, val))
REDUCE_WINDOW_OP(f8e5m2_t, f8e5m2_t, min_f8e5m2, F8E5M2_POS_INF, acc = MIN(acc, val))
REDUCE_WINDOW_OP(bf16_t, bf16_t, min_bf16, BF16_POS_INF, acc = MIN(acc, val))
REDUCE_WINDOW_OP(f16_t, f16_t, min_f16, F16_POS_INF, acc = MIN(acc, val))
