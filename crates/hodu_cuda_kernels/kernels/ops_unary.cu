...
UNARY_OP(__nv_fp8_e4m3, bool, isnan_f8e4m3, isnan(to_float(x)))
UNARY_OP(__nv_fp8_e4m3, bool, isinf_f8e4m3, isinf(to_float(x)))
UNARY_OP(__nv_fp8_e4m3, bool, isfinite_f8e4m3, isfinite(to_float(x)))
...
UNARY_OP(__nv_fp8_e5m2, bool, isnan_f8e5m2, isnan(to_float(x)))
UNARY_OP(__nv_fp8_e5m2, bool, isinf_f8e5m2, isinf(to_float(x)))
UNARY_OP(__nv_fp8_e5m2, bool, isfinite_f8e5m2, isfinite(to_float(x)))
...
UNARY_OP(__nv_bfloat16, bool, isnan_bf16, isnan(to_float(x)))
UNARY_OP(__nv_bfloat16, bool, isinf_bf16, isinf(to_float(x)))
UNARY_OP(__nv_bfloat16, bool, isfinite_bf16, isfinite(to_float(x)))
...
UNARY_OP(__half, bool, isnan_f16, isnan(to_float(x)))
UNARY_OP(__half, bool, isinf_f16, isinf(to_float(x)))
UNARY_OP(__half, bool, isfinite_f16, isfinite(to_float(x)))
...
UNARY_OP(float, bool, isnan_f32, isnan(x))
UNARY_OP(float, bool, isinf_f32, isinf(x))
UNARY_OP(float, bool, isfinite_f32, isfinite(x))
...
UNARY_OP(double, bool, isnan_f64, isnan(x))
UNARY_OP(double, bool, isinf_f64, isinf(x))
UNARY_OP(double, bool, isfinite_f64, isfinite(x))
